...
if __name__ == '__main__':
    ...
    train_dir = 'D:/Downloads/HDR-VAM-main/dataset/train/LDR/short/'
    val_dir = 'D:/Downloads/HDR-VAM-main/dataset/valid/LDR/short/'
    ...
    call_back = [tf.keras.callbacks.ModelCheckpoint(filepath= 'weights.h5',save_best_only=True), 
                ...
                keras.callbacks.ReduceLROnPlateau(monitor='val_peak_signal_noise_ratio',factor=0.1,patience=25,verbose=0,mode='max')]
